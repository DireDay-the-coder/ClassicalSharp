...
namespace Launcher.Gui.Widgets
{
    ...
    {
        public string Hash, Name, Online, Max, Uptime, IP, Software, RawUptime, Flag;
        public int Y, Height;
    ...
    public partial class TableWidget : Widget
    {
        ...
        public int[] ColumnWidths = new int[] { 32, 325, 65, 65, 65, 65, 625};
        public int[] DesiredColumnWidths = new int[] { 32, 325, 65, 65, 65, 65, 625};
